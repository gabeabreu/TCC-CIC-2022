...
const BigCard = ({ pictureUrl, likesNumber, title, description, availableNfts, key }: Props) => {
  return (
    <div key={key} className="w-[17rem] h-[30rem] ml-28 flex flex-col items-center justify-center">
      <div className="px-5 pt-5 pb-6 flex bg-mds-white bg-opacity-20 bg-clip-padding rounded-t-2xl border-t-4 border-x-4 border-[#fdfdfd44]">
        <div className="w-[23.625rem] h-[10.5rem] rounded-xl relative overflow-hidden">
      ...
      <div className="bg-mds-white px-5 py-6 w-[26.6rem] rounded-b-2xl flex flex-col justify-center items-center">
